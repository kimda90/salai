...
- [`0008-external-harness-owns-agent-runtime.md`](0008-external-harness-owns-agent-runtime.md) — current boundary: external harness owns model/session behavior; Salai exposes one narrow machine interface over `SalaiProjectService`.
